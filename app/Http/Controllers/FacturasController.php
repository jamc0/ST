...
class FacturasController extends Controller
{
	...
	//	 dd($cliente,$vehiculo,$guia_remision);
        return view('adminlte::venta.factura',compact('clientes', 'guia_remision'));
  }
 public function GuardarFactura(Request $request)
    {
       ...
       // dd($data);
        ...
        if ($bresultado) {
            return redirect('Factura/Factura2')->with('status','Se Registro la Factura Correctamente.');
        } else {
            return redirect('Factura/Factura2')->with('erros','La Factura no ha sido registrada.');
        }
    }

	...
	<div class="container-fluid spark-screen">
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
	        	...
	        	<form method="POST" action="<?php echo e(url('Categoria/Editar')); ?>" accept-charset="UTF-8" class="" id="EditarFormCategorias">
	        		<input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
	                                    <div class="form-group row">
	                                        <div class="col-sm-4">
	                                          <label class="color-azul">Nombre Categoría:</label>
	                                          <input type="text" class="form-control text-center"  id="nombre_categoria" name="nombre_categoria"  required placeholder="nombre_categoria" maxlength="20" value="<?php echo e($categorias[0]->nombre_categoria); ?>">
	                                          <span  id ="ErrorMensaje-nombre_categoria" class="help-block"></span>
	                                        </div>
	                                        <div class="col-sm-4">
	                                          <label class="color-azul">Descripción:</label>
	                                          <input type="text" class="form-control text-center"  id="descripcion" name="descripcion"  required placeholder="Descripcion" maxlength="50" value="<?php echo e($categorias[0]->descripcion); ?>">
		...
		<input type="text" name="id" id="id" class="form-control text-center" value="<?php echo e($categorias[0]->id); ?>" style="display:none;">
	          </form>
        	</div>
		</div>
	</div>

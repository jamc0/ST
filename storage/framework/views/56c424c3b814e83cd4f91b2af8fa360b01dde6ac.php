...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="<?php echo e(url('home')); ?>"><i class='fa fa-hand-o-right'></i> <span><?php echo e(trans('adminlte_lang::message.home')); ?></span></a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo e(url('Transporte/Crud')); ?>">Transportes</a></li>

    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <?php if(Auth::guest()): ?>
                    <a id="LinkAcme" name="LinkAcme" class="navbar-brand" href="<?php echo e(url('/login')); ?>"></span> Iniciar Sesión</a>
                    <a id="LinkAcme" name="LinkAcme" class="navbar-brand" href="<?php echo e(url('/register')); ?>"></span> Registrarse</a>
                <?php else: ?>
                    <a id="LinkAcme" name="LinkAcme" class="navbar-brand" href="/home"></i> <span class="light"></span> <?php echo e(Auth::user()->name); ?></a>
                <?php endif; ?>
                ...
                <div class="col-sm-12 col-md-4 col-md-offset-1" style="background-image: url('landing/img/fondo-form.jpg')" >
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-md-offset-1" >
                            <form name="sentMessage" id="contactForm" action="<?php echo e(url('/')); ?>" method="POST" enctype="plain" novalidate>

	...
	<div class="container-fluid spark-screen">
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<form method="POST" action="<?php echo e(url('Boleta/Pedido')); ?>" accept-charset="UTF-8" class="" id="RegistroFormFactura">
						...
						<div class="form-group">
							...
							<select name="persona_id"  id="persona_id" class="form-control selectpicker" data-live-search="true">
			            	 	<?php $__currentLoopData = $personas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			            			<option value="<?php echo e($persona->id); ?>"><?php echo e($persona->RazonSocial); ?></option>

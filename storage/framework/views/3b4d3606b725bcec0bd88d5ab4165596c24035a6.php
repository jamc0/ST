						...
						<div class="form-group">
							...
							<select name="persona_id"  id="persona_id" class="form-control selectpicker" data-live-search="true">
			            	 	<?php $__currentLoopData = $personas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			            			<option value="<?php echo e($persona->persona_id); ?>"><?php echo e($persona->Nombres . " " .$persona->cApellidoPaterno . " " .$persona->cApellidoMaterno); ?></option>
						...
						<div class="form-group">
							...
							<select name="transporte_id"  id="transporte_id" class="form-control selectpicker" data-live-search="true">
			            	 	<?php $__currentLoopData = $transportes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			            			<option value="<?php echo e($transporte->id); ?>"><?php echo e($transporte->nombre_transporte); ?></option>
			            		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			            	</select>
						</div>
					</div>

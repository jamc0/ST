...
<input type="hidden" name="_method" value="put">
  ...
  <button type="submit" class="btn btn-labeled btn-success"><span class="btn-label"><i class="fa fa-check"></i></span><?php echo e(trans('entrust-gui::button.save')); ?></button>
  <a class="btn btn-labeled btn-warning" href="<?php echo e(route('entrust-gui::roles.index')); ?>"><span class="btn-label"><i class="fa fa-chevron-left"></i></span><?php echo e(trans('entrust-gui::button.cancel')); ?></a>
</form>
<?php $__env->stopSection(); ?>
